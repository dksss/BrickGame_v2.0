...
#define HISCORE_FILENAME "tetris.score"

/**
 * @brief Перечисление состояний КА
 */
typedef enum {
  START_GAME = 0,
  SPAWN_FIG,
...
/**
 * @brief Функция, предназначена для обработки таймера в контексте игры,
 *  определяя, пришло ли время для сдвига фигуры вниз
 */
...
/**
 * @brief Функция, инициализирующая начальное игровое время
 */
void init_timer(struct timespec* begin);

/**
 * @brief Функция, проверяющая пришло ли время изменить состояние игры
 *  для сдвига фигуры
 */
